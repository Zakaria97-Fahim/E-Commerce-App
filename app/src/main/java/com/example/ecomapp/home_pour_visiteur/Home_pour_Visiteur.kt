...
import com.example.ecomapp.customer_home.FilterActivity
...
class Home_pour_Visiteur : AppCompatActivity() {
    ...
    private fun displayFilteredProducts(filteredProducts: List<Product>) {
        ...
        val adapter = Adapter_Pour_Visiteur(this, productList)
    ...
    private fun callAdapter(products: List<Product>, list: RecyclerView) {
        val adapter = Adapter_Pour_Visiteur(this, products.toMutableList())
